"""Encoder registry — the decoupling seam between xaq and plugins.

xaq registers its built-in generic encoders here. Third-party packages
(e.g. the private AMI-Awen audio product) contribute additional encoders via
the setuptools entry-point group ``xaq.encoders`` — xaq never imports

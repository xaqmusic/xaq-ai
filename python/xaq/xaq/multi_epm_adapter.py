...
from xaq.cpp_adapter       import CppEPMAdapter, _TransmitterStub, _ReceiverStub, _SessionLoggerStub
from xaq.consistency_gate  import ConsistencyGate
from xaq.lateral_voter_v3  import LateralVoterV3
from xaq.zmq_bus           import RealityTokenSubscriber
...
class MultiEPMAdapter:
    ...
    def __init__(self,
        ...
        from xaq.cpp_adapter import _MemoryProxy

...
These prove the Zanshin audio slot is IP-free, deterministic, and API-compatible
...
from zanshin.encoders import make_encoder
from zanshin.encoders.audio import FrozenSTFTEncoder

...
**Zanshin** (残心 — "the mind that remains," sustained awareness after action) is
an open research framework for **embodied active inference**: a System-1
...
python -c "from zanshin.encoders import make_encoder; import numpy as np; \
...
Zanshin is licensed under the [Apache License 2.0](LICENSE), which places **no
...
We built Zanshin to advance open research in active inference and embodied
...
In that spirit, we ask that you **do not use Zanshin to develop autonomous
...
determined to ignore it; it would also make Zanshin harder to build on, teach
...
*Zanshin is a research framework, provided as-is. It is not legal or safety

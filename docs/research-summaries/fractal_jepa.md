...
> **Status: aspirational / deferred.** This is a forward-looking position paper. The Fractal JEPA Workspace — and in particular the Mitosis Gatekeeper and the autopoietic node-spawning it describes — is a proposed research direction, not shipped xaq behaviour. It sketches where the architecture could grow, not what it does today.

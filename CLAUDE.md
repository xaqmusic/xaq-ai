...
| Working on the **microduck** | [`microduck port plan`](docs/plans-and-designs/microduck_port_plan.md) — the MuJoCo host (`mj_host`) and the duck's sensorimotor surface. **Design-stage; nothing built.** Branch `microduck-sim` |

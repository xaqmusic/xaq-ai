...
// =============================================================================
// KeyframeAverager.hpp  --  Phase v5.2 sensor / motor downsampler
// =============================================================================
//
...
//
//   keyframe_motor_left  (window=50, source=action.left)  →  reality.proprio.motor_avg_left
//   keyframe_motor_right (window=50, source=action.right) →  reality.proprio.motor_avg_right
//   epm_motor_slow_left  (process_every_n_ticks=50, input=reality.proprio.motor_avg_left)
//
...
class KeyframeAverager : public Module {
public:
    KeyframeAverager();
    ~KeyframeAverager() override;
...
private:
    ...
    std::string output_topic_    = "reality.proprio.motor_avg";
